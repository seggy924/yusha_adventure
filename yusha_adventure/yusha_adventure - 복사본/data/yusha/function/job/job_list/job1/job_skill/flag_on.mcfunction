...
execute at @a run playsound minecraft:item.trident.hit_ground master @a ~ ~ ~ 1 0
execute at @a run playsound minecraft:item.trident.return master @a ~ ~ ~ 1 0.5
execute at @a run playsound minecraft:entity.generic.explode ambient @a ~ ~ ~ 1 2
